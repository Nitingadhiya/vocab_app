...
Future<void> setupLocator() async {
  ...
  locator.registerLazySingleton(
    () => HomeCubit(vocabRepository: locator<VocabRepository>(), preferencesProvider: locator<PreferencesProvider>()),
  );
  ...
  locator.registerFactory(() => CategoryDetailCubit(vocabRepository: locator<VocabRepository>()));
